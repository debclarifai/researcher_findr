...
def search_results(first_name, last_name, display=None):
  #driver = webdriver.Chrome()
  base_url = 'https://www.linkedin.com/search/results/index/?keywords=firstname%3A{0}%20AND%20lastname%3A{1}&origin=GLOBAL_SEARCH_HEADER'.format(first_name, last_name)
...
if __name__ == '__main__':
  ...
  for key in dict:
    for i in range(len(dict[key])):
      ...
      csv_dict['url'].append(search_results(name[1], name[0]))
